# Rocky Face Mountain Hypothesis - Living Summary
...
### 318 Haiku Theory (The Numerical Key)
...
**Triple Confirmation:**
- Haiku = 3 + 18 = 318
- Trail marker 318 exists on Hollow Rock Trail
- Park is exactly 318 acres
...
### Dancers Jewelry Theory

The black-and-white illustration of dancers (Page 61, Chapter 5) features **colorful jewelry pieces** - an unusual choice for an otherwise monochrome image.
...
## Children's Book Clue Interpretations
...
## Why Rocky Face Over Alternatives?
...
See `alternatives/los-angeles.md` for full steelman analysis.

### Why NOT South Mountains State Park?

Main treasure book has ZERO references to South Mountains, Burke County, Clear Creek, Jacob Fork, or High Shoals. The explicit "Hiddenite" mention (Ch 4), "Alexander" chapter title (Ch 21), and 318 triple encoding all point to Rocky Face.

See `alternatives/south-mountains.md` for full steelman analysis.

---

## Author's Family Property Proximity
...
|---|---------------|--------|--------|
| 1 | Public lands near Hiddenite | **DONE** | Rocky Face Mountain (318 acres, 5 mi trails, marker 318) |
| 2 | Haiku numerical analysis | **DONE** | 3 lines + 18 syllables = marker 318 |
| 3 | Trail marker verification | **DONE** | Marker 318 confirmed on trail map |
| 4 | Rocky Face Park website analysis | **DONE** | 318 acres, GPS coords, butterfly host plant confirmed |
| 5 | Necklace theory analysis | **DONE** | Visual trail map encoding; orange bead = 319-320 rock outcrop |
