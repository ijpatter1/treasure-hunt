...
|------|-------------|--------|
| Andrew Carnegie's emerald in matrix | Green Colombian emerald, uncut in dark matrix rock | Muzo Mine, Boyacá Dept., Colombia |

**Provenance:** Part of Carnegie's rare mineral collection. After his death, passed through a few owners before author acquired it.
...
## CRITICAL: Author's Current Location
...
Mount Wilson is in the San Gabriel Mountains, northeast of Los Angeles. **This confirms the author currently lives in the Los Angeles area** (likely west or southwest of Mount Wilson).
...
| **Current home** | **Los Angeles area** (Mount Wilson "not far...to the northeast") |
...
| Muzo Mine, Colombia | Emerald origin | Low |
| Dunfermline, Scotland | Carnegie birthplace | Low |
...
| Person | Role |
|--------|------|
| **Andrew Carnegie** | Emerald owner, philanthropist |
| J.P. Morgan | Bought Carnegie's steel companies |
| Thomas A. Scott | Carnegie's first mentor |
| Edwin Hubble | Used Mount Wilson telescope for discoveries |
| Brian Tracy | Opening quote |
| Steve Goodier | Opening quote |
...
- Almost 1,700 libraries (800+ still operating)
- $350 million total given
- "Gospel of Wealth" (1889): "The man who dies thus rich dies disgraced"
